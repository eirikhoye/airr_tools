...
"""
Script for merging all Hill diversity and evenness profiles 
into tidy dataframe, and calculate area under the curve (AUC)
"""
...
# Concatenate all Hill profile dataframes
df <- file_paths %>%
