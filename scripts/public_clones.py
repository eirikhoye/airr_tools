...
"""
Script for calculating clonal sharing level (number of patients where
the clone was detected).

To use, change the paths for input files to paths on your system.

Files are located in goolge drive folder linked to in the repository
README.md
"""
...
meta_path1 = '/path/to/data/immunarch_data_376276/metadata.txt'
meta1 = pd.read_csv(meta_path1, sep='\t')
meta1['COMET_ID_group'] = meta1['COMET_ID'] + '_group:_' + meta1['group']
meta1.index = meta1['Sample']

meta_path2 = '/path/to/data/immunarch_data_12511620/metadata.txt'
...
airr_dict = {}
file_dir = '/path/to/data/immunarch_data_376276/'
...
file_dir = '/path/to/data/immunarch_data_12511620/'
...
out_file_path = '/path/to/data/public_clones.txt'
out_file_path2 = '/path/to/data/public_clones_sharing_level.csv'
...
out_dir_public = '/path/to/data/rearrangement_files_with_sharing_public/'
...
out_dir_private = '/path/to/data/rearrangement_files_with_sharing_private/'
for k, v in airr_dict_sub.items():
...
out_dir_all = '/path/to/data/rearrangement_files_with_sharing_all/'
for k, v in airr_dict_sub.items():
